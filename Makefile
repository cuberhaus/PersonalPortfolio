...
# All ports used by demo backends — derived from the validated registry adapter
# at parse time so Makefile, dev-all-demos.sh, LiveAppEmbed and Sentry all read
# from one source. The literal list is a defensive fallback only.
DEMO_PORTS := $(shell node scripts/demo-registry.mjs --ports 2>/dev/null || echo "8888 8889 8890 8082 8001 8083 8084 8085 8086 8087 8088 8089 8090 8081 8092 8093 8000 3000 8765")
E2E_HOST ?= 127.0.0.1
E2E_PORT ?= 4322
...
include scripts/demo-build-targets.mk

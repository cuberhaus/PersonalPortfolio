...
export const TRANSPORTS: Transport[] = [
  ...
  {
    id: 't12',
    name: 'Flight New York→Miami',
    fromCityId: 'nueva_york',
    toCityId: 'miami',
    mode: 'Avion',
    price: 90,
    duration: 3,

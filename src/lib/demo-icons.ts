/**
 * Single source of truth for icon SVG inner content used across the homepage
 * card sections (demos, work projects, etc.). Keys must match the `icon`
 * field in the corresponding data file (`demos.json`, `work_projects.json`).
 *
 * Each path is the inner content of a 24×24 SVG with `fill="none"
 * stroke="currentColor"` defaults, so callers can render at any size.
 */
export const ICON_PATHS: Record<string, string> = {
  ...
  graph:
    '<circle cx="5" cy="6" r="2.5"/><circle cx="19" cy="6" r="2.5"/><circle cx="12" cy="18" r="2.5"/><circle cx="5" cy="18" r="2.5"/><circle cx="19" cy="18" r="2.5"/><line x1="7" y1="7" x2="17" y2="7"/><line x1="6" y1="8" x2="11" y2="16"/><line x1="18" y1="8" x2="13" y2="16"/><line x1="7" y1="18" x2="10" y2="18"/>',
  scatter:
  ...
  helicopter:
    '<path d="M4 14h5l2 3h2l2-3h5"/><circle cx="9" cy="14" r="2"/><circle cx="15" cy="14" r="2"/><path d="M12 8v3M9 5l1.5 4M15 5l-1.5 4"/><path d="M2 12h20" opacity="0.5"/>',
  aorta:
    '<path d="M12 21V10"/><path d="M8 6c0-2 1.5-3.5 4-3.5s4 1.5 4 3.5v4c0 2-1.5 3.5-4 3.5s-4-1.5-4-3.5V6z"/><path d="M6 14h12" opacity="0.4"/><circle cx="12" cy="17" r="1.5" fill="currentColor" stroke="none"/>',
  ...
  microscope:
    '<circle cx="12" cy="9" r="3"/><path d="M12 12v4"/><path d="M8 21h8"/><path d="M12 16v5"/><path d="M7 3l2 6"/><path d="M17 3l-2 6"/><circle cx="12" cy="9" r="6" opacity="0.3"/>',
  server:
  ...
  brain:
    '<path d="M12 2a5 5 0 015 5c0 1.5-.5 2.5-1.5 3.5S14 12 14 14h-4c0-2-.5-2.5-1.5-3.5S7 8.5 7 7a5 5 0 015-5z"/><path d="M10 14v3a2 2 0 104 0v-3"/><path d="M9 7h.01M15 7h.01M9 9c.5.5 1.5 1 3 1s2.5-.5 3-1"/>',
};

    ...
    <div style={styles.wrapper}>
      ...
      {view === 'category' && category && (
        <div>
          ...
          >
            <button
              style={{ ...styles.button, ...styles.secondaryBtn, padding: '0.35rem 0.75rem' }}
              onClick={goHome}
            >
              {t.backHome}
            </button>
              ...
              <div style={{ ...styles.card, overflowX: 'auto' }}>
                <table style={styles.table}>
                      ...
                      <tr key={p.id}>
                        ...
                        <td style={styles.td}>
                          <input
                            ...
                            onChange={(e) =>
                              updateCartQty(p.id, Math.max(0, Number(e.target.value) || 0))
                            }
                          />
                        </td>
                  ...
                  <tr>
                    <td
                      colSpan={3}
                      style={{ ...styles.td, textAlign: 'right' as const, fontWeight: 600 }}
                    >
                      {t.totalLabel}
                    </td>
      ...
      {view === 'checkout' && (
        <div>
          {orderPlaced ? (
            ...
            <>
              <button
                style={{ ...styles.button, ...styles.secondaryBtn, marginBottom: '1rem' }}
                onClick={() => setView('cart')}
              >
                {t.backToCart}
              </button>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        setCheckoutForm((f) => ({ ...f, userType: 'registered' as const }))
                      }
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        setCheckoutForm((f) => ({ ...f, userType: 'guest' as const }))
                      }
                      style={{ marginRight: '0.5rem' }}
                    />
                    {t.guest}
                  ...
                  {checkoutForm.userType === 'registered' && (
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setCheckoutForm((f) => ({ ...f, password: e.target.value }))
                        }
                      />
                    </div>
                  )}

    ...
    >
      ...
      {cities.map((c) => (
        <g key={c.id}>
          ...
          <text x={c.x} y={c.y + 30} textAnchor="middle" fill="var(--text-muted)" fontSize="8">
            ★{c.interest}
          </text>
        </g>
      ))}
    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0.75rem 0 0', fontSize: '0.72rem', color: 'var(--text-muted)' }}>
          ...
          >
            cd Practica_de_Planificacion && make dev
          </code>
        </p>
      </div>
      ...
      >
        ...
        <div style={card}>
          ...
          >
            {t.flightDesc1}
            <code style={{ color: 'var(--text-muted)' }}>cg1</code>
            {t.flightDesc2}
          </p>
        </div>
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ color: 'var(--text-muted)' }}>
                    {totalDays} {t.mockDays}
                  </span>
                  <span style={{ color: 'var(--text-muted)' }}>
                    {t.mockInterest}: {totalInterest}
                  </span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '0.72rem' }}>
                    {t.mockRoute}:{' '}
                    {['cg1', ...MOCK_PLAN.map((p) => p.to)].map((c, i, arr) => (
                      <span key={c}>
                ...
                <details>
                  <summary
                    style={{ fontSize: '0.72rem', color: 'var(--text-muted)', cursor: 'pointer' }}
                  >
                    {t.mockActions}
                  </summary>
                  <ol

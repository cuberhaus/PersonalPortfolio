...
const TRANSLATIONS = {
  en: {
    banner: "Interactive mock of the SBC trip planner expert system. Start the backend (<code>cd SBC_IA && make web-dev</code>) for the full experience.",
    stepOf: "Step {n} of 10",
    next: "Next",
    back: "Back",
    plan: "Plan my trip!",
  ...
  es: {
    banner: "Mock interactivo del planificador de viajes SBC. Inicia el backend (<code>cd SBC_IA && make web-dev</code>) para la experiencia completa.",
    stepOf: "Paso {n} de 10",
    next: "Siguiente",
    back: "Atrás",
  ...
  ca: {
    banner: "Mock interactiu del planificador de viatges SBC. Inicia el backend (<code>cd SBC_IA && make web-dev</code>) per l'experiència completa.",
    stepOf: "Pas {n} de 10",
    next: "Següent",
    back: "Enrere",

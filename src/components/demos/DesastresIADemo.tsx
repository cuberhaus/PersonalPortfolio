...
function SchematicSvg({ t }: { t: typeof TRANSLATIONS.en }) {
  return (
    <svg
      ...
      aria-label="Disaster relief layout"
    >
      <defs>
      ...
      <text x="66" y="78" textAnchor="middle" fill="var(--text-muted)" fontSize="8">
        H0, H1
      </text>
      ...
      <text x="66" y="148" textAnchor="middle" fill="var(--text-muted)" fontSize="8">
        H2
      </text>
      ...
      <text x="200" y="95" fill="var(--text-muted)" fontSize="9" fontFamily="ui-monospace">
        {t.rescueOrder}
      </text>
    </svg>
  );
      ...
      try {
        ...
        const r =
          algoVal === 'HC'
            ...
            : simulatedAnnealing(board, initial, {
                steps: 10000,
                t0: 350,
                cooling: 0.99955,
        ...
        setRunOut({
          seed: seedVal,
          algo: algoVal === 'HC' ? t.hcFull : t.saFull,
          cost: r.cost,
          initialCost,
          initial: initialSnap,
    ...
    >
      ...
      <div
        style={{
          ...
          background:
            'linear-gradient(135deg, color-mix(in srgb, var(--accent-start) 8%, transparent), color-mix(in srgb, var(--accent-end) 6%, transparent))',
      ...
      >
        ...
        <div style={card}>
            ...
            {t.heuristics.map((h) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: '0.5rem',
                  border: h.active
                    ? '1px solid color-mix(in srgb, var(--accent-start) 40%, transparent)'
              ...
              >
                ...
                <div
                  style={{
                    fontSize: '0.75rem',
                    color: h.active ? 'var(--text-primary)' : 'var(--text-muted)',
                    lineHeight: 1.4,
                  }}
                >
                  {h.desc}
          ...
          <p style={{ margin: '0.5rem 0 0', fontSize: '0.68rem', color: 'var(--text-muted)' }}>
            {t.succNote1}
            <code style={{ color: 'var(--text-muted)' }}>DesastresSuccessorFunction1–6</code>
            {t.succNote2}
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          {t.howDesc1}
          <strong style={{ color: 'var(--text-primary)' }}>{t.howDesc2}</strong>
          {t.howDesc3}
          <strong style={{ color: 'var(--text-primary)' }}>{t.howDesc4}</strong>
          {t.howDesc5}
        </div>
        ...
        >
          ...
          >
            ...
            <select
              value={algo}
              onChange={(e) => {
                const v = e.target.value as 'HC' | 'SA';
                setAlgo(v);
                log.info('algo', { algo: v });
              }}
              style={{
            ...
            return (
              <div style={{ fontSize: '0.82rem' }}>
                ...
                <details style={{ marginTop: '0.75rem' }}>
                  <summary
                    style={{ cursor: 'pointer', color: 'var(--text-muted)', fontSize: '0.78rem' }}
                  >
                    {t.initialState}
                  </summary>

...
function SimulatedInference({ t }: { t: typeof TRANSLATIONS.en }) {
  ...
  return (
    <div>
      ...
      >
        {t.simDesc1}
        <strong style={{ color: 'var(--text-primary)' }}>{t.simDesc2}</strong>
        {t.simDesc3}
        <strong style={{ color: 'var(--text-primary)' }}>{t.simDesc4}</strong>
        {t.simDesc5}
      </p>
      ...
      >
        ...
        {phase === 'running' && (
          <span style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>{stepLabel}</span>
        )}
        {phase === 'done' && (
          <>
            <button
...
function DiameterExplorer({ t }: { t: typeof TRANSLATIONS.en }) {
  ...
  return (
    <div>
      ...
      >
        {t.diamDesc1}
        <strong style={{ color: 'var(--text-primary)' }}>{t.diamDesc2}</strong>
        {t.diamDesc3}
      </p>
      ...
      <div
        style={{
          ...
          position: 'relative',
          background:
            'linear-gradient(90deg, #22c55e 0%, #22c55e 35%, #eab308 35%, #eab308 65%, #ef4444 65%, #ef4444 100%)',
        }}
      >
        <div
          style={{

...
export const ui = {
  en: {
    ...
    'design.glass.name':      'Glass',
    'design.glass.blurb':     'Translucent cards, aurora blur, soft shadows',
    'design.swiss.name':      'Swiss',
    'design.swiss.blurb':     'Strict grid, giant numerals, hairline rules',
    'design.neumorphic.name': 'Neumorphic',
    'design.neumorphic.blurb':'Soft pillowy UI with inset / outset shadows',
  ...
  es: {
    ...
    'design.glass.name':      'Cristal',
    'design.glass.blurb':     'Tarjetas translúcidas, aurora borrosa, sombras suaves',
    'design.swiss.name':      'Suizo',
    'design.swiss.blurb':     'Retícula estricta, números enormes, filetes finos',
    'design.neumorphic.name': 'Neumórfico',
    'design.neumorphic.blurb':'UI suave y acolchada con sombras interiores y exteriores',
  ...
  ca: {
    ...
    'design.glass.name':      'Vidre',
    'design.glass.blurb':     'Targetes translúcides, aurora difusa, ombres suaus',
    'design.swiss.name':      'Suís',
    'design.swiss.blurb':     'Retícula estricta, números enormes, filets fins',
    'design.neumorphic.name': 'Neumòrfic',
    'design.neumorphic.blurb':'UI suau i encoixinada amb ombres interiors i exteriors',
    'design.pixel.name':      'Píxel',

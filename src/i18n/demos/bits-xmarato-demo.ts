...
export const TRANSLATIONS = {
  en: {
    ...
    diameterZones: {
      typical: {
        label: 'Typical range',
        detail: 'Many adult abdominal aortic diameters fall well below 30 mm.',
      },
      followup: {
        label: 'Follow-up zone',
        detail:
          'Dilated \u2014 periodic imaging often recommended. Real decisions depend on growth rate and morphology.',
      },
      concern: {
        label: 'High concern',
        detail:
          'Large diameter \u2014 may warrant specialist review. This is an educational illustration only.',
      },
    },
    ...
    diamDesc1:
      'The app estimates aortic diameter from segmented contours. Drag to see how a measurement maps to ',
  ...
  es: {
    ...
    diameterZones: {
      typical: {
        label: 'Rango típico',
        detail: 'Muchos diámetros aórticos abdominales de adultos están muy por debajo de 30 mm.',
      },
      followup: {
        label: 'Zona de seguimiento',
        detail:
          'Dilatada \u2014 a menudo se recomienda seguimiento por imagen. Las decisiones reales dependen del ritmo de crecimiento y morfología.',
      },
      concern: {
        label: 'Alta preocupación',
        detail:
          'Diámetro grande \u2014 puede requerir revisión por un especialista. Esto es solo una ilustración educativa.',
      },
    },
    ...
    diamDesc1:
      'La app estima el diámetro aórtico desde contornos segmentados. Arrastra para ver cómo una medida se mapea a cubos de riesgo ',
    ...
    localDesc3: ' (',
    localDesc4:
      '). Necesitas un entorno compatible con CUDA para la inferencia de Mask R-CNN (PyTorch 1.13).',
  ...
  ca: {
    ...
    diameterZones: {
      typical: {
        label: 'Rang típic',
        detail: "Molts diàmetres aòrtics abdominals d'adults estan molt per sota de 30 mm.",
      },
      followup: {
        label: 'Zona de seguiment',
        detail:
          'Dilatada \u2014 sovint es recomana seguiment per imatge. Les decisions reals depenen del ritme de creixement i morfologia.',
      },
      concern: {
        label: 'Alta preocupació',
        detail:
          'Diàmetre gran \u2014 pot requerir revisió per un especialista. Això és només una il·lustració educativa.',
      },
    },
    ...
    diamDesc1:
      "L'app estima el diàmetre aòrtic des de contorns segmentats. Arrossega per veure com una mesura es mapeja a cubs de risc ",
    diamDesc2: 'educatius',
    ...
    localDesc3: ' (',
    localDesc4:
      '). Necessites un entorn compatible amb CUDA per a la inferència de Mask R-CNN (PyTorch 1.13).',

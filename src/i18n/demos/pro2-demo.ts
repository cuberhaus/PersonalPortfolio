...
export const TRANSLATIONS = {
  en: {
    ...
    step3Desc1:
      ' — the algorithm repeatedly merges the two closest clusters, averaging their distances to all other clusters. Click ',
    ...
    step4: '4. Dendrogram',
    step4Desc:
      ' — the resulting phylogenetic tree shows how species are related. Closer branches = more similar genes.',
  ...
  es: {
    ...
    step3Desc1:
      ' — el algoritmo fusiona repetidamente los dos clústeres más cercanos, promediando sus distancias a los demás clústeres. Haz clic en ',
    ...
    step4: '4. Dendrograma',
    step4Desc:
      ' — el árbol filogenético resultante muestra cómo se relacionan las especies. Ramas más cercanas = genes más similares.',
    ...
    kmerTooltip:
      'longitud del k-mer: mayor k significa distancia más precisa pero requiere genes más largos',
    addBtn: 'Añadir',
  ...
  ca: {
    ...
    step3: '3. Clustering WPGMA',
    step3Desc1:
      " — l'algorisme fusiona repetidament els dos clústers més propers, promediant les seves distàncies als altres clústers. Fes clic a ",
    ...
    step4: '4. Dendrograma',
    step4Desc:
      " — l'arbre filogenètic resultant mostra com es relacionen les espècies. Branques més properes = gens més similars.",
    ...
    kmerTooltip:
      'longitud del k-mer: major k significa distància més precisa però requereix gens més llargs',
    addBtn: 'Afegir',

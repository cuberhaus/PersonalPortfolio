...
export const TRANSLATIONS = {
  en: {
    ...
    // panelHeading / panelDesc render the in-page island info card; the
    // demo card heading on the homepage comes from src/data/demos.json.
    panelHeading: "Phase Transitions in Random Graphs",
    panelDesc: "Generate random graphs and apply percolation (random removal of nodes or edges) to observe phase transitions \u2014 the sharp change from connected to disconnected as the retention probability drops. Each connected component is shown in a different color.",
  ...
  es: {
    ...
    panelDesc: "Genera grafos aleatorios y aplica percolación (eliminación aleatoria de nodos o aristas) para observar transiciones de fase \u2014 el cambio brusco de conectado a desconectado a medida que la probabilidad de retención disminuye. Cada componente conectada se muestra en un color diferente.",
  ...
  ca: {
    ...
    panelDesc: "Genera grafs aleatoris i aplica percolació (eliminació aleatòria de nodes o arestes) per observar transicions de fase \u2014 el canvi brusc de connectat a desconnectat a mesura que la probabilitat de retenció disminueix. Cada component connectada es mostra en un color diferent.",

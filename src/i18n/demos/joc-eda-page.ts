...
export const JOC_EDA_COPY: Record<JocEdaLang, JocEdaCopy> = {
  en: {
    ...
    uploadDesc:
      'Compile and run the game locally, then upload the <code>.out</code> replay file to watch it here.',
    ...
    step1:
      'Clone the <a href="https://github.com/cuberhaus/joc_eda" target="_blank" rel="noopener noreferrer">repository</a>',
    step2:
      'Write your own AI in a file like <code>AIMyBot.cc</code> (extend the <code>Player</code> class)',
  ...
  es: {
    ...
    uploadDesc:
      'Compila y ejecuta el juego localmente, luego sube el archivo de repetición <code>.out</code> para verlo aquí.',
    ...
    fileTooLarge:
      'Archivo demasiado grande para el almacenamiento de la sesión. Intenta con una repetición más pequeña.',
    ...
    step1:
      'Clona el <a href="https://github.com/cuberhaus/joc_eda" target="_blank" rel="noopener noreferrer">repositorio</a>',
    step2:
      'Escribe tu propia IA en un archivo como <code>AIMyBot.cc</code> (extiende la clase <code>Player</code>)',
  ...
  ca: {
    ...
    uploadDesc:
      "Compila i executa el joc localment, després puja l'arxiu de repetició <code>.out</code> per veure'l aquí.",
    ...
    fileTooLarge:
      "Arxiu massa gran per a l'emmagatzematge de la sessió. Prova amb una repetició més petita.",
    ...
    step1:
      'Clona el <a href="https://github.com/cuberhaus/joc_eda" target="_blank" rel="noopener noreferrer">repositori</a>',
    step2:
      'Escriu la teva pròpia IA en un arxiu com <code>AIMyBot.cc</code> (estén la classe <code>Player</code>)',

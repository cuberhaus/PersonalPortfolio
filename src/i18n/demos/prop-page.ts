...
export const PROP_COPY: Record<PropLang, PropCopy> = {
  en: {
    ...
    unavailDesc:
      'This Java Spring Boot application only runs locally during development. <br/>Check out the source code below to run it yourself!',
    ...
    step3:
      'The app will run at <a href="http://localhost:8081" target="_blank" rel="noopener">localhost:8081</a>',
  ...
  es: {
    ...
    unavailDesc:
      'Esta aplicación Java Spring Boot solo se ejecuta localmente durante el desarrollo. <br/>¡Revisa el código fuente a continuación para ejecutarla tú mismo!',
    runLocal: 'Ejecutar la app real localmente',
    step1: '<code>cd subgrup-prop7.1</code>',
    step2: '<code>make web</code> — compila e inicia el servidor Spring Boot',
    step3:
      'La app se ejecutará en <a href="http://localhost:8081" target="_blank" rel="noopener">localhost:8081</a>',
  ...
  ca: {
    ...
    demoUnavail: 'Demo no disponible',
    unavailDesc:
      "Aquesta aplicació Java Spring Boot només s'executa localment durant el desenvolupament. <br/>Revisa el codi font a continuació per executar-la tu mateix!",
    runLocal: "Executar l'app real localment",
    step1: '<code>cd subgrup-prop7.1</code>',
    step2: '<code>make web</code> — compila i inicia el servidor Spring Boot',
    step3:
      'L\'app s\'executarà a <a href="http://localhost:8081" target="_blank" rel="noopener">localhost:8081</a>',

...
function onWindowResize (event) {
    ...
    // Set canvas size — use window.innerWidth/Height for iframe compatibility
    var w = window.innerWidth || document.body.offsetWidth;
    var h = window.innerHeight || document.body.offsetHeight;
    var size = Math.min(w, h - header_height) - canvas_margin*2;
    if (size < 100) size = Math.min(w, h) - canvas_margin*2;
